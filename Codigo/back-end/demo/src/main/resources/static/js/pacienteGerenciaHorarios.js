async function carregarSessoesAgendadas() {
    try {
        ...
        const response = await fetch(`https://historical-pepi-puc-tis-d0d4bf2c.koyeb.app/agendamentos/usuario/${pacienteId}`, {
            method: 'GET',
            headers: {
...
async function cancelarAgendamento(id) {
    ...
    try {
        const response = await fetch(`https://historical-pepi-puc-tis-d0d4bf2c.koyeb.app/agendamentos/${id}`, {
            method: 'DELETE',
            headers: {
                "Content-Type": "application/json",
